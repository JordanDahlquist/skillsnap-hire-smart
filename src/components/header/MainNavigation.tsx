...
export const MainNavigation = ({ 
  ...
  return (
    <>
          ...
          <Link
            ...
            className={`px-3 py-2 text-sm font-medium transition-colors flex items-center gap-2 ${
              location.pathname === item.href || location.pathname.startsWith(item.href + '/')
                ...
                : "text-foreground hover:text-[#007af6]"
            }`}
          >
      ...
      {/* Mobile Navigation */}
      {isMobileMenuOpen && (
        <div className="absolute top-16 left-0 right-0 bg-background border-b border-border md:hidden backdrop-blur-xl shadow-lg">
              ...
              <Link
                ...
                className={`block px-3 py-2 text-sm font-medium transition-colors flex items-center gap-2 rounded-md ${
                  location.pathname === item.href || location.pathname.startsWith(item.href + '/')
                    ...
                    : "text-foreground hover:text-[#007af6] hover:bg-accent"
                }`}
