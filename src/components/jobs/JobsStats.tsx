  ...
  return <div className="">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2">
          <Card className={`group relative overflow-hidden border-0 bg-white/95 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-200 ${onNeedsAttentionClick ? 'cursor-pointer hover:scale-[1.02]' : ''} ${needsAttentionActive ? 'ring-1 ring-orange-400 shadow-orange-50' : ''}`} onClick={onNeedsAttentionClick}>
            ...
            <CardContent className="relative p-4">
              <div className="flex items-start justify-between mb-2">
                ...
                {stats.jobsNeedingAttention > 0 && <Badge className="bg-orange-500 text-white border-0 px-1 py-0 text-[9px] font-medium h-3">
                    !
                  </Badge>}
              </div>
              <div className="space-y-1">
                ...
                {needsAttentionActive && <Badge className="bg-orange-200 text-orange-800 border-0 text-[8px] px-1 py-0 h-2.5">
                    Active
                  </Badge>}
              </div>
            </CardContent>
          ...
          <Card className={`group relative overflow-hidden border-0 bg-white/95 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-200 ${onActiveJobsClick ? 'cursor-pointer hover:scale-[1.02]' : ''} ${activeJobsFilterActive ? 'ring-1 ring-blue-400 shadow-blue-50' : ''}`} onClick={onActiveJobsClick}>
            ...
            <CardContent className="relative p-4">
              <div className="flex items-start justify-between mb-2">
                ...
                {activeJobsFilterActive && <Badge className="bg-blue-500 text-white border-0 px-1 py-0 text-[9px] font-medium h-3">
                    ✓
                  </Badge>}
              </div>
              <div className="space-y-1">
                ...
                {activeJobsFilterActive && <Badge className="bg-blue-200 text-blue-800 border-0 text-[8px] px-1 py-0 h-2.5">
                    Active
                  </Badge>}
              </div>
            </CardContent>
