...
const buttonVariants = cva(
  "relative inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-3xl text-sm font-medium ring-offset-background transition-all duration-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:scale-105 active:scale-95 overflow-hidden group",
  {
    variants: {
      variant: {
        default: "backdrop-blur-2xl bg-gradient-to-br from-blue-500/50 via-blue-600/40 to-indigo-600/45 text-white shadow-[0_8px_32px_rgba(0,0,0,0.12),0_0_0_1px_rgba(255,255,255,0.15)_inset,0_1px_0_rgba(255,255,255,0.25)_inset,0_-1px_0_rgba(0,0,0,0.05)_inset] border border-white/15 hover:shadow-[0_16px_48px_rgba(0,0,0,0.18),0_0_0_1px_rgba(255,255,255,0.25)_inset,0_2px_0_rgba(255,255,255,0.35)_inset,0_-1px_0_rgba(0,0,0,0.08)_inset] hover:bg-gradient-to-br hover:from-blue-500/60 hover:via-blue-600/50 hover:to-indigo-600/55 hover:border-white/25 before:absolute before:inset-0 before:bg-gradient-to-br before:from-white/30 before:via-white/15 before:to-white/5 before:opacity-0 hover:before:opacity-100 before:transition-opacity before:duration-500 after:absolute after:inset-[1px] after:rounded-3xl after:bg-gradient-to-br after:from-white/20 after:via-white/8 after:to-transparent after:pointer-events-none",
        "magnifying-glass": "backdrop-blur-3xl backdrop-saturate-[200%] backdrop-brightness-[140%] bg-gradient-to-br from-white/45 via-white/35 to-white/25 text-slate-900 font-semibold shadow-[0_20px_60px_rgba(0,0,0,0.25),0_0_0_2px_rgba(255,255,255,0.8)_inset,0_2px_0_rgba(255,255,255,0.9)_inset,0_-2px_0_rgba(0,0,0,0.1)_inset,0_0_40px_rgba(255,255,255,0.6)] border-2 border-white/40 hover:scale-110 hover:shadow-[0_30px_80px_rgba(0,0,0,0.35),0_0_0_3px_rgba(255,255,255,0.9)_inset,0_3px_0_rgba(255,255,255,1)_inset,0_-2px_0_rgba(0,0,0,0.1)_inset,0_0_60px_rgba(255,255,255,0.8)] hover:backdrop-brightness-[160%] hover:backdrop-saturate-[250%] hover:bg-gradient-to-br hover:from-white/60 hover:via-white/50 hover:to-white/40 hover:border-white/60 before:absolute before:inset-0 before:bg-gradient-radial before:from-white/70 before:via-white/30 before:to-white/10 before:opacity-0 hover:before:opacity-100 before:transition-all before:duration-700 after:absolute after:top-[3px] after:left-[15%] after:right-[15%] after:h-[4px] after:bg-gradient-to-r after:from-transparent after:via-white/90 after:to-transparent after:rounded-full after:blur-[1px] after:opacity-60 hover:after:opacity-100 after:transition-all after:duration-500",
