    ...
    const getVariantClasses = (variant: string | null | undefined) => {
      ...
      switch (variant) {
        ...
        case 'destructive':
          ...
          return isDark
            ? "bg-red-900 text-white border border-red-700 hover:bg-red-800 hover:border-red-600 shadow-lg hover:shadow-xl"
        ...
        case 'outline':
          ...
          return isDark
            ? "bg-black text-white border border-white/30 hover:bg-gray-900 hover:border-white/40 shadow-lg hover:shadow-xl"
        ...
        case 'secondary':
          ...
          return isDark
            ? "bg-gray-800 text-white border border-white/20 hover:bg-gray-700 hover:border-white/30 shadow-lg hover:shadow-xl"
        ...
        case 'ghost':
          ...
          return isDark
            ? "bg-transparent text-white border border-white/10 hover:bg-gray-900 hover:border-white/20 shadow-lg hover:shadow-xl"
            : "backdrop-blur-2xl bg-gradient-to-br from-white/8 via-white/5 to-white/2 text-slate-700 shadow-[0_4px_16px_rgba(0,0,0,0.04),0_0_0_1px_rgba(255,255,255,0.1)_inset] border border-white/8 hover:bg-gradient-to-br hover:from-white/18 hover:via-white/12 hover:to-white/6 hover:text-slate-900 hover:shadow-[0_8px_24px_rgba(0,0,0,0.08),0_0_0_1px_rgba(255,255,255,0.2)_inset,0_1px_0_rgba(255,255,255,0.25)_inset] hover:border-white/15 before:absolute before:inset-0 before:bg-gradient-to-br before:from-white/20 before:via-white/10 before:to-white/3 before:opacity-0 hover:before:opacity-100 before:transition-opacity before:duration-500";
