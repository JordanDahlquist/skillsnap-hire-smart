  ...
  <DialogPortal>
    ...
    >
      ...
      <div className="relative z-10">
        {children}
        <DialogPrimitive.Close className="absolute right-6 top-6 rounded-2xl p-2 backdrop-blur-sm bg-white/20 hover:bg-white/30 border border-white/30 opacity-70 ring-offset-background transition-all hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground">
          <X className="h-5 w-5" />
